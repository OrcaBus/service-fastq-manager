...
if __name__ == "__main__":
    ...
    print(json.dumps(
        handler(
            {
                "ntsmS3UriA": "s3://ntsm-fingerprints-472057503814-ap-southeast-2/ntsm/year=2025/month=07/day=14/f0268443-6a46-44bd-b8f2-04d93fa6823c/fqr.01JR42NCWXRYJANXA1JXQCK9NC.ntsm",
                "ntsmS3UriB": "s3://ntsm-fingerprints-472057503814-ap-southeast-2/ntsm/year=2025/month=07/day=14/510ee81b-9c0c-4c29-901a-1b5f61cf727e/fqr.01JRKRGF6RXZEGAQVMJRMFYDMR.ntsm"
            },
            None
        ),
        indent=4
